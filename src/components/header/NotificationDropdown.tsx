                  ...
                  notifications.map((n) => (
                    <li key={n.id}>
                      <DropdownItem
                        ...
                        className="flex relative items-center gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-4 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                      >
                        ...
                        <span className="block">
                          <div className="mb-1.5 space-x-1 block text-theme-sm text-gray-500 dark:text-gray-40">
                            <h6 className="font-medium text-gray-800 dark:text-white/90">{n.title}</h6>
                            <span>{n.message}</span>
                          </div>

                          <span className="flex items-center gap-2 capitalize text-gray-500 text-theme-xs dark:text-gray-400">
                            <span>{n.type}</span>
